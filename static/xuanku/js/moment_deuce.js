...
function createDeuce() {
	...
	loader.add("http://file.eacho.online/lightning-red.png");
	loader.add("http://file.eacho.online/lightning-blue.png");
	loader.add("http://file.eacho.online/circle-red.png");
	loader.add("http://file.eacho.online/circle-blue.png");
	loader.add("http://file.eacho.online/streak-red.png");
	loader.add("http://file.eacho.online/streak-blue.png");
	...
	function onAssetsLoaded() {
		...
		deuceEm_Shard1 = new Emitter({
			...
			{ 	type 		:	DoubleParticle, 
				image		:	"http://file.eacho.online/shard-white.png", 
				life		: 	1000.0,
				spin		: 	[0,0],
				speed		: 	[0.05, 1],
				scale		: 	[0.05,0.7],
		...
		// LIGHTNING SHARD
		deuceTextureLightning1 = PIXI.Texture.fromImage("http://file.eacho.online/lightning1.png");
		...
		deuceTextureLightning2 = PIXI.Texture.fromImage("http://file.eacho.online/lightning2.png");
		...
		//STREAKS
		deuceTextureStreak1 = PIXI.Texture.fromImage("http://file.eacho.online/streak1.png");
		deuceTextureStreak2 = PIXI.Texture.fromImage("http://file.eacho.online/streak2.png");
