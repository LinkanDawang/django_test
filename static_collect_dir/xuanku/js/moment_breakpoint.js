...
function createBreakPoint() {
	...
	loader.add("http://file.eacho.online/color1shard1.png");
	loader.add("http://file.eacho.online/color1shard2.png");
	loader.add("http://file.eacho.online/color1shard3.png");
	loader.add("http://file.eacho.online/color1shard4.png");
	loader.add("http://file.eacho.online/color1shard5.png");
	loader.add("http://file.eacho.online/color1shard6.png");
	loader.add("http://file.eacho.online/color1shard7.png");
	loader.add("http://file.eacho.online/color1shard8.png");
	loader.add("http://file.eacho.online/color2shard1.png");
	loader.add("http://file.eacho.online/color2shard2.png");
	loader.add("http://file.eacho.online/color2shard3.png");
	loader.add("http://file.eacho.online/explosion1.png");
	loader.add("http://file.eacho.online/explosion2.png");
	loader.add("http://file.eacho.online/explosion3.png");
	loader.add("http://file.eacho.online/explosion4.png");
	loader.add("http://file.eacho.online/explosion5.png");
	loader.add("http://file.eacho.online/explosion6.png");
	loader.add("http://file.eacho.online/explosion7.png");
	loader.add("http://file.eacho.online/explosion8.png");
	loader.add("http://file.eacho.online/explosion9.png");
	loader.add("http://file.eacho.online/explosion10.png");
	loader.add("http://file.eacho.online/explosion11.png");
	loader.add("http://file.eacho.online/explosion12.png");
	loader.add("http://file.eacho.online/explosion13.png");
	...
	function onAssetsLoaded() {
		...
		// COLOR 1 SHARDS
		breakPointColor1ShardTexture1 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard1.png");
		...
		breakPointColor1ShardTexture2 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard2.png");
		...
		breakPointColor1ShardTexture3 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard3.png");
		...
		breakPointColor1ShardTexture4 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard4.png");
		...
		breakPointColor1ShardTexture5 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard5.png");
		...
		breakPointColor1ShardTexture6 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard6.png");
		...
		breakPointColor1ShardTexture7 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard7.png");
		...
		breakPointColor1ShardTexture8 = PIXI.Texture.fromImage("http://file.eacho.online/color1shard8.png");
		...
		// COLOR 2 SHARDS
		breakPointColor2ShardTexture1 = PIXI.Texture.fromImage("http://file.eacho.online/color2shard1.png");
		...
		breakPointColor2ShardTexture2 = PIXI.Texture.fromImage("http://file.eacho.online/color2shard2.png");
		...
		breakPointColor2ShardTexture3 = PIXI.Texture.fromImage("http://file.eacho.online/color2shard3.png");
		...
		for (var i = 0; i < 13; i++) {
			...
			var breakPointExplosionTexture = PIXI.Texture.fromImage("http://file.eacho.online/explosion" + i + ".png");
