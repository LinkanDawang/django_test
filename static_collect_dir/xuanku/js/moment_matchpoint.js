...
function createMatchPoint() {
	...
	loader.add("http://file.eacho.online/octagon.png");
	loader.add("http://file.eacho.online/bar.png");
	loader.add("http://file.eacho.online/bar2.png");
	loader.add("http://file.eacho.online/stripes.png");
	loader.add("http://file.eacho.online/bar-piece1.png");
	loader.add("http://file.eacho.online/bar-piece2.png");
	loader.add("http://file.eacho.online/bar-piece3.png");
	loader.add("http://file.eacho.online/lightning1.png");
	loader.add("http://file.eacho.online/lightning2.png");
	loader.add("http://file.eacho.online/lightning3.png");
	loader.add("http://file.eacho.online/lightning4.png");
	loader.add("http://file.eacho.online/bar-swirl1.png");
	loader.add("http://file.eacho.online/bar-swirl2.png");
	...
	function onAssetsLoaded() {
		...
		matchPointEm_TennisBalls = new Emitter({
			...
			{ 	type 		:	SimpleParticle, 
				image		:	"http://file.eacho.online/ball-white.png", 
				life		: 	800.0,
				spin		: 	[-0.03, 0.03],
				speed		: 	[1, 3],
				scale		: 	[0.1,0.2],
		...
		matchPointEm_ThinShards = new Emitter({
			...
			{ 	type 		:	SimpleParticle, 
				image		:	"http://file.eacho.online/shard2-white.png", 
				life		: 	1000.0,
				spin		: 	[0,0],
				speed		: 	[0.05, 1],
				scale		: 	[0.05, 1],
		...
		// STRIPES
		matchPointSwirlTexture1 = PIXI.Texture.fromImage("http://file.eacho.online/bar-swirl1.png");
		...
		matchPointSwirlTexture2 = PIXI.Texture.fromImage("http://file.eacho.online/bar-swirl2.png");
		...
		// STRIPES
		matchPointStripesTexture = PIXI.Texture.fromImage("http://file.eacho.online/stripes.png");
		...
		// OCTAGON
		matchPointOctagonMiniTexture = PIXI.Texture.fromImage("http://file.eacho.online/octagon.png");
		...
		matchPointBarPiece1Texture = PIXI.Texture.fromImage("http://file.eacho.online/bar-piece1.png");
		matchPointBarPiece2Texture = PIXI.Texture.fromImage("http://file.eacho.online/bar-piece2.png");
		matchPointBarPiece3Texture = PIXI.Texture.fromImage("http://file.eacho.online/bar-piece3.png");
		for (var i = 0; i < 3; i++) {
		...
		matchPointLightningTexture1 = PIXI.Texture.fromImage("http://file.eacho.online/lightning1.png");
		...
		matchPointLightningTexture2 = PIXI.Texture.fromImage("http://file.eacho.online/lightning2.png");
		...
		matchPointLightningTexture3 = PIXI.Texture.fromImage("http://file.eacho.online/lightning3.png");
		...
		matchPointLightningTexture4 = PIXI.Texture.fromImage("http://file.eacho.online/lightning4.png");
