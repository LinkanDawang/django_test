...
function createHomepage() {
	...
	loader.add("http://file.eacho.online/angle-white.png");
	loader.add("http://file.eacho.online/shard3-white.png");
	loader.add("http://file.eacho.online/glow.png");
	loader.add("http://file.eacho.online/triangle2-white.png");
	loader.add("http://file.eacho.online/logo.png");
	...
	function onAssetsLoaded() {
		...
		homepageEm_ThinShards = new Emitter({
			...
			{ 	type 		:	SimpleParticle, 
				image		:	"http://file.eacho.online/shard3-white.png", 
				life		: 	1000.0,
				spin		: 	[0,0],
				speed		: 	[0.1, 0.2],
				scale		: 	[0.5, 1],
		...
		// CENTERED GLOW
		homepageTextureGlow = PIXI.Texture.fromImage("http://file.eacho.online/glow.png");
		...
		var homepageTextureTriangle = PIXI.Texture.fromImage("http://file.eacho.online/triangle2-white.png");
		for (var i = 0; i < 10; i++) {
		...
		// BEGIN MOVING ANGLES
		// LEFT ANGLES
		homepageTextureAngle = PIXI.Texture.fromImage("http://file.eacho.online/angle-white.png");
		...
		// LOGO
		homepageTextureLogo = PIXI.Texture.fromImage("http://file.eacho.online/logo.png");
